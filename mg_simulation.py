...
def simyr(eld=elast_d, sd=1):
    per_lbls = ["ulw", "ulp", "avg_p", "dsctd_hrs", "hh_bill", "hh_rev", "bat_bill", "bat_bill_tot", "p_nom"]
...
#yr_output, per_output = simyr(-0.69, 2)
